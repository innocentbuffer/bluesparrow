            ...
            <div class="trusted">
                ...
                <div class="">
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item px-4"><img src="images/loved/softcom.png" style="width:150px" alt=""></li>
                        <li class="list-inline-item px-4"><img src="images/loved/disrupt.png" style="width:150px" alt=""></li>
                        <li class="list-inline-item px-4"><img src="images/loved/softcom.png" style="width:150px" alt=""></li>
                        <li class="list-inline-item px-4"><img src="images/loved/softcom.png" style="width:150px" alt=""></li>
                    </ul>
                </div>
