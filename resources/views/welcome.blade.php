...
-->
        ...
        <section class="other-section2 pt-5">
            <div class="row mx-0">
                <div class="col-12 col-md-8 px-md-5 px-1">
                    <h3 class="project-color mb-3">Start Growing with BlueSparrow Today</h3>
                    <img src="images/items/illustration1.png" alt="" style="width:100%" class="d-block d-md-none">
                    ...
                    <button class="mt-3 py-3 px-5 text-white start-journey mx-auto mx-md-0 d-flex mb-5">
                        Start your journey
                    </button>
                </div>
    ...
    <img src="images/items/footerimg.png" alt="" style="width:100%;position: absolute;height: 100%;">
        <div class="footer-text"> 
            <div class="row mx-0">
                ...
                <div class="col-md-2 mb-4 mb-md-0">
                    <h6 class="mb-3 mb-md-4"><strong>RESOURCES</strong> </h6>
                    <ul class="list-inline">
                        <li>Community</li>
                ...
                <div class="col-md-3">
                    <h6 class="mb-3 mb-md-4"><strong>TERMS OF USE</strong> </h6>
                    <ul class="list-inline">
                        <li>Cookies</li>
